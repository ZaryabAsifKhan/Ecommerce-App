    ...
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-4 min-h-[80vh] border-t'>
      ...
      <div className='mt-8'>
        ...
        <div onClick={()=> setMethod('stripe')} className ='flex items-center gap-3 border border-gray-300 rounded p-2 px-3 cursor-pointer'>
          <p className = {`min-w-3.5 h-3.5 border border-gray-500 rounded-full ${method === 'stripe' ? 'bg-green-500 border-green-500': ''}`}></p>
         ...
         <div onClick={()=> setMethod('razorpay')} className ='flex items-center gap-3 border border-gray-300 rounded p-2 px-3 cursor-pointer'>
          <p className = {`min-w-3.5 h-3.5 border border-gray-500 rounded-full ${ method === 'razorpay' ? 'bg-green-500 border-green-500': ''}`}></p>
          ...
          <p className = {`min-w-3.5 h-3.5 border border-gray-500 rounded-full ${method === 'cod' ? 'bg-green-500 border-green-500': ''}`}></p>
         ...
         <div className = 'w-full text-end mt-8'>
          <button onClick={()=>navigate('/orders')} className = 'bg-black text-white px-16 py-3 text-sm hover:bg-gray-800 cursor-pointer'>PLACE ORDER</button>
        </div>
